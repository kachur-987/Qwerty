...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { client_id: @good.client_id, content: @good.content, title: @good.title } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { client_id: @good.client_id, content: @good.content, title: @good.title } }
